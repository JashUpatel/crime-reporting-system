...
<div class="body container border">
	...
	<h1 style="text-shadow: 1.5px 1.5px 2.5px #c1c1c1; text-transform:capitalize; margin:2.5% 0;"> Complaint Details</h1>
		...
		{
		$fname=mysqli_real_escape_string($conn,$_POST['FirstComplainantName']);
		$lname=mysqli_real_escape_string($conn,$_POST['LastComplainantName']);
		$email=mysqli_real_escape_string($conn,$_POST['email']);
		$contact=mysqli_real_escape_string($conn,$_POST['phno']);
		$complaint=mysqli_real_escape_string($conn,$_POST['compid']);

		$sql="SELECT * FROM lodgecomplaint WHERE complaint_id='$complaint' AND email='$email'";
...
<table class="table table-border">
  ...
  <tr>
    <td colspan="">
      <label for="email">Place of Occurence
        <!-- <font color="RED">*</font> -->
...
<tr>
  <td colspan="">
    <label for="phone">Police Station
      <!-- <font color="RED">*</font> -->
